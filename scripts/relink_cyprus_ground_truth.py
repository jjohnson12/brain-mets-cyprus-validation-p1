...
Example:
  python relink_cyprus_ground_truth.py \
    --dataset /path/to/analysis_workspace/dataset.csv \
    --zip-root /path/to/cyprus_archives \
    --output-root /path/to/analysis_workspace/reference_masks_relinked \
    --out-dataset /path/to/analysis_workspace/dataset_relinked.csv \
    --summary /path/to/analysis_workspace/relink_summary.txt
