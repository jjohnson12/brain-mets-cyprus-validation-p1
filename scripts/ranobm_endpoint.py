#!/usr/bin/env python3
"""
ranobm_endpoint.py  (v2 - dataset.csv driven)
=============================================
Primary modified RANO-BM trajectory endpoint for the SPIRS-P1 external
validation on the Flouri (Cyprus) longitudinal brain-metastases benchmark.
...
Emits in one run:
  - 3x3 reference-vs-predicted RANO-BM contingency  (-> Figure 2C)
...
Run:
    ...
    python ranobm_endpoint.py --output-dir /path/to/analysis_workspace
